# QA Analysis Query: det_empi_crosswalk_pct_bar_to_athena_coverage

**Source file:** `analyses/det_empi_crosswalk_pct_bar_to_athena_coverage.sql`  
**GitHub permalink:** https://github.com/UpperlineHealth-Tech/Acratica-ETL/blob/1a2168e26e17e6bf7338c1a66df79cf384927491/analyses/det_empi_crosswalk_pct_bar_to_athena_coverage.sql?plain=1#L1-L25
...
```bash
dbt compile --select analyses/det_empi_crosswalk_pct_bar_to_athena_coverage.sql
```
