# QA Analysis Query: qa_checks_silver_status_updates

**Source file:** `analyses/qa_checks_silver_status_updates.sql`  
**GitHub permalink:** https://github.com/UpperlineHealth-Tech/Acratica-ETL/blob/1a2168e26e17e6bf7338c1a66df79cf384927491/analyses/qa_checks_silver_status_updates.sql?plain=1#L1-L99
...
- `{{ ref('silver_status_updates_athena') }}`
- `{{ ref('silver_status_updates_bar') }}`
...
```bash
dbt compile --select analyses/qa_checks_silver_status_updates.sql
```
