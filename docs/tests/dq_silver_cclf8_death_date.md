# Data Quality Check: dq_silver_cclf8_death_date (CCLF8)

**Source file:** `models/data_quality/CCLF8/dq_silver_cclf8_death_date.sql`  
**GitHub permalink:** https://github.com/UpperlineHealth-Tech/Acratica-ETL/blob/1a2168e26e17e6bf7338c1a66df79cf384927491/models/data_quality/CCLF8/dq_silver_cclf8_death_date.sql?plain=1#L1-L29
...
The core “validity” logic is implemented here: https://github.com/UpperlineHealth-Tech/Acratica-ETL/blob/1a2168e26e17e6bf7338c1a66df79cf384927491/models/data_quality/CCLF8/dq_silver_cclf8_death_date.sql?plain=1#L5-L12
...
```bash
dbt build --select dq_silver_cclf8_death_date
```
