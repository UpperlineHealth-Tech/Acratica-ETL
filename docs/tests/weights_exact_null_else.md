# QA Analysis Query: weights_exact_null_else

**Source file:** `analyses/weights_exact_null_else.sql`  
**GitHub permalink:** https://github.com/UpperlineHealth-Tech/Acratica-ETL/blob/1a2168e26e17e6bf7338c1a66df79cf384927491/analyses/weights_exact_null_else.sql?plain=1#L1-L715
...
```bash
dbt compile --select analyses/weights_exact_null_else.sql
```
