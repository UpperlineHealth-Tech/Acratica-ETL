# QA Analysis Query: points_relative_frequency

**Source file:** `analyses/points_relative_frequency.sql`  
**GitHub permalink:** https://github.com/UpperlineHealth-Tech/Acratica-ETL/blob/1a2168e26e17e6bf7338c1a66df79cf384927491/analyses/points_relative_frequency.sql?plain=1#L1-L46
...
```bash
dbt compile --select analyses/points_relative_frequency.sql
```
