# QA Analysis Query: det_pairs_num_pairs_by_rule

**Source file:** `analyses/det_pairs_num_pairs_by_rule.sql`  
**GitHub permalink:** https://github.com/UpperlineHealth-Tech/Acratica-ETL/blob/1a2168e26e17e6bf7338c1a66df79cf384927491/analyses/det_pairs_num_pairs_by_rule.sql?plain=1#L1-L4
...
```bash
dbt compile --select analyses/det_pairs_num_pairs_by_rule.sql
```
