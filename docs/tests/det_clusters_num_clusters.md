# QA Analysis Query: det_clusters_num_clusters

**Source file:** `analyses/det_clusters_num_clusters.sql`  
**GitHub permalink:** https://github.com/UpperlineHealth-Tech/Acratica-ETL/blob/1a2168e26e17e6bf7338c1a66df79cf384927491/analyses/det_clusters_num_clusters.sql?plain=1#L1-L3
...
```bash
dbt compile --select analyses/det_clusters_num_clusters.sql
```
